/**
 * The two static lists the new-book wizard offers.
 *
 * Cover styles are art directions handed to the image model, phrased as
 * recognisable publishing house looks so the results feel like book covers
 * rather than stock illustration. Topics seed the "surprise me" button and are
 * deliberately broad, since the wizard's job is to get someone past the blank
 * field rather than to guess what they wanted.
 *
 * They live here rather than in the component because they are data, they are
 * long, and they change for entirely different reasons than the wizard does.
 */
