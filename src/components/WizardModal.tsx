...
const RANDOM_TOPICS = [
  ...
  'How to Build Better Personal Style',
  'How to Build Better Personal Style',
  ...
  // Hobbies
  'Learn Guitar Without Getting Stuck',
  'Piano for Complete Beginners',
  'Sing Better Without Feeling Embarrassed',
  'Music Theory That Actually Makes Sense',
  'Songwriting for Non-Musicians',
  'Learn to Read Sheet Music',
  'Ear Training for Everyday Musicians',
  'Write Better Lyrics',
  'Learn Chess Without Memorizing Everything',
  'Chess Strategy for Casual Players',
  'Learn Poker Without Losing Your Shirt',
  'Get Into Board Games as an Adult',
  'Tabletop RPGs for Beginners',
  'Learn Go, the Board Game',
  'Start Gaming as an Adult',
  'Get Better at Strategy Games',
  'Cooking Basics for Hobby Cooks',
  'Learn to Bake Bread',
  'Learn to Make Pizza at Home',
  'Coffee Brewing for Enthusiasts',
  'Tea for Curious Beginners',
  'Fermentation for Beginners',
  'Learn Hiking as a Hobby',
  'Backpacking for Beginners',
  'Learn Camping Comfortably',
  'Learn a New Language for Fun',
  'Spanish for Travel and Conversation',
  'Japanese for Anime and Travel Fans',
  'Learn Sign Language Basics',
  'Learn Latin for Curiosity',
  'Read Poetry for Pleasure',
  'Learn to Write Fiction',
  'Start a Personal Blog',
  'Learn Creative Nonfiction',
  'Start a Newsletter as a Hobby',
  'Wine Without the Snobbery',
  'Whiskey for Curious Beginners',
  'Learn to Host Better Dinner Parties',
  'Make Better Playlists',
  'Build a Better Movie Taste',
  'Learn to Appreciate Art and Museums',
  'Learn Magic Tricks People Actually Enjoy',
  'Speedcubing From Beginner to Fast',
  'Learn Drums From Scratch',
  'Learn Knife Skills',
  'Home Recording for Beginners',
  'Learn Music History Through Great Albums',
  'Learn DJing From First Principles',
  'Learn Storytelling as a Creative Hobby',
  'Learn Humor Writing for Fun',

  // Education
  'Learn Economics Without the Jargon',
  'Personal Finance in Plain English',
  'Investing From Scratch',
  'Understand Inflation, Interest Rates, and Markets',
  'How Taxes Actually Work',
  'Learn Business Fundamentals',
  'Understand Supply and Demand',
  'Learn Accounting Without Fear',
  'Read Financial Statements Like an Adult',
  'Understand Startups and Venture Capital',
  'Learn American History Through Big Turning Points',
  'World History That Explains the Present',
  'Ancient Rome for Modern Thinkers',
  'Ancient Greece and the Origins of Western Thought',
  'The History of Religion in Plain English',
  'Learn the History of Science',
  'The Industrial Revolution and Why It Still Matters',
  'The History of Capitalism',
  'Modern Middle East History for Beginners',
  'How Democracies Rise and Fall',
  'Learn Philosophy Without Pretension',
  'Stoicism for Real Life',
  'Ethics for Everyday Decisions',
  'Existentialism in Plain English',
  'Political Philosophy for Non-Academics',
  'How to Think Critically',
  'Logic and Reasoning for Everyday Life',
  'Learn Probability Without Hating Math',
  'Understand Cognitive Biases',
  'Learn First-Principles Thinking',
  'Math for Adults Who Feel Rusty',
  'Algebra From Scratch',
  'Statistics for Normal People',
  'Learn Calculus Conceptually',
  'How to Read Graphs and Charts',
  'Data Literacy for Everyone',
  'Learn Linear Algebra Intuitively',
  'Math for Finance and Investing',
  'Mental Models That Make You Smarter',
  'Physics Without the Math Panic',
  'Learn How the Universe Works',
  'Chemistry in Everyday Life',
  'Biology for Curious Adults',
  'Learn Genetics in Plain English',
  'Human Anatomy for Beginners',
  'Nutrition Science Without Fads',
  'Learn Climate Science Clearly',
  'Understand Energy, Oil, and Electricity',
  'Neuroscience for Non-Scientists',
  'Learn Psychology Without Pop-Psych Nonsense',
  'Social Psychology and Human Behavior',
  'Developmental Psychology Across the Lifespan',
  'Understand Anxiety, Stress, and Emotion',
  'Behavioral Economics for Everyday Decisions',
  'Learn Memory and Learning Science',
  'Attachment Theory in Plain English',
  'Personality Psychology Without Stereotypes',
  ...
  'Learn JavaScript by Making Real Projects',
  'Understand AI Without the Hype',
  'Machine Learning for Curious Adults',
  'Learn SQL and Data Basics',
  'How the Internet Actually Works',
  'Cybersecurity for Normal People',
  'Learn APIs Without Confusion',
  'Learn Grammar So You Can Write Better',
  'Write Clearly and Think Clearly',
  'Learn Rhetoric and Persuasion',
  'Public Speaking From First Principles',
  'Learn Storytelling as a Skill',
  'Read Great Literature More Deeply',
  'Learn Linguistics for Curiosity',
  'Learn to Read Better Nonfiction',
  'Learn How to Learn',
  'Understand Law in Plain English',
  'Contracts for Normal People',
  'Understand Healthcare Systems',
  'Learn Media Literacy',
  'How Journalism Works',
  'Understand Propaganda and Persuasion',
  'Learn Geopolitics Without Sensationalism',
  'Understand Cities, Housing, and Urbanism',
  'Understand Design From First Principles',
  'Learn Art History Without Boredom',
  'Music History Through Great Songs',
  'Understand Religion Across Cultures',
  'Learn Anthropology for Everyday Life',
  'Learn Sociology Through Real Examples',
  'The History of Food and Civilization',
  'Understand Human Evolution',
  'Learn Education Theory as a Parent or Teacher',
  'Build a Personal Curriculum for Self-Education',
  ...
  'How Culture Works',
  'How Nutrition and Metabolism Work',
  'How Courts Work',
]
